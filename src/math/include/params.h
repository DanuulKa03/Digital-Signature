...
namespace ntru {
    ...
    // ���������� ��������� �� ���������� (��� ��������� IO)
    inline void set_params(const int N, const int Q, const int D, const double NU, const int NORM_BOUND,
        const double ETA, const int ALPHA, const int SIGMA, const int MAX_SIGN_ATT = 1000)
    {
